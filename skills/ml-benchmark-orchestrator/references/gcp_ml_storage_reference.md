...
> **Cold Read Guarantee**: Before every test invocation, `sync; echo 3 > /proc/sys/vm/drop_caches` was executed on the `n4-standard-80` node to purge all Linux Kernel Page Cache, Dentries, and Inodes from host RAM.
